...
<body style="background-color:#1d3557">
    ...
    <header>
     ...
     <div id="text_image_inicio">
        <h3>Presenteie quem você<strong id="color_text">Ama</strong> com<strong id="color_text">Egift</strong></h3>
    ...
    <div class="Login">
        <div class="content_form">
            <h1>Logar</h1>
            <div id="options_user">
                <li><a href="LoginF.php">Vou Vender</a></li>
                <li class="a"><a href="Login.php">Vou Comprar</a></li>
            </div>
            <form action="composer/loginU.php" method="POST">
